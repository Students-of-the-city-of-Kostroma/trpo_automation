...
StrategyLab::StrategyLab(QObject* parent)
    : QObject(parent)
{
    logfile::logInfo(QString("Include XML config"));
...
{
    logfile::logInfo(QString("Check string for inheritance"));
...
{
    logfile::logInfo("Testing for an abstract class");
