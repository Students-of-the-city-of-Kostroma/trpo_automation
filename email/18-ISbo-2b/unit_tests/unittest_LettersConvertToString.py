...
class MyTestCase(unittest.TestCase):
    def test_S_4_t1(self):
        ...
        letters = []
        letter = Letter.Letter(student, "ЛР01", "https://github.com/Students-of-the-city-of-Kostroma/TasksOfStudents/tree/master/18-%D0%98%D0%A1%D0%B1%D0%BE-2/%D0%9B%D0%A001", None, 4)
        ...
        letter_true = Letter.Letter(student_true, "ЛР01", "https://github.com/Students-of-the-city-of-Kostroma/TasksOfStudents/tree/master/18-%D0%98%D0%A1%D0%B1%D0%BE-2/%D0%9B%D0%A001", None, 4)
        letters_true = []
    ...
    def test_S_4_t2(self):
        ...
        letter = Letter.Letter(student, "ЛР01",
                               "https://github.com/Students-of-the-city-of-Kostroma/TasksOfStudents/tree/master/18-%D0%98%D0%A1%D0%B1%D0%BE-2/%D0%9B%D0%A001",
                               None, 1)
        letters.append(letter)
        letters = LettersConvertToString(letters)
    ...
    def test_S_4_t4(self):
        ...
        student = User.User("Валерий Бублин", "18-ИСбо-2", None, None)
        letters = []
        letter = Letter.Letter(student, "ЛР01", "https://github.com/Students-of-the-city-of-Kostroma/TasksOfStudents/tree/master/18-%D0%98%D0%A1%D0%B1%D0%BE-2/%D0%9B%D0%A002", None, 4)
        letter.CodeStatus = "20"
        letters.append(letter)
        letters = LettersConvertToString(letters)
        ...
        "Правильные данные"
        student_true = User.User("Валерий Бублин", "18-ИСбо-2", None, None)
        letter_true = Letter.Letter(student_true, "ЛР01", "https://github.com/Students-of-the-city-of-Kostroma/TasksOfStudents/tree/master/18-%D0%98%D0%A1%D0%B1%D0%BE-2/%D0%9B%D0%A002", None, 4)
        letter_true.Body = "https://github.com/Students-of-the-city-of-Kostroma/TasksOfStudents/tree/master/18-%D0%98%D0%A1%D0%B1%D0%BE-2/%D0%9B%D0%A002"
        letters_true = []
        letters_true.append(letter_true)
        self.assertEqual(letters[0].Body, letters_true[0].Body)
    ...
    def test_S_4_t5(self):
        ...
        "Правильные данные"
        student_true = User.User("Валерий Бублин", "18-ИСбо-2", None, None)
        letter_true = Letter.Letter(student_true, "ЛР01", "https://www.youtube.com/watch?v=b5hM5nydmXU&t=2566s", None, 4)
        letter_true.Body = ""
